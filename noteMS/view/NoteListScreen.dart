    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return Card(
          ...
          child: Stack(
            children: [
              // Content area (title, content, dates) wrapped in InkWell
              Positioned.fill(
                top: 0,
                left: 0,
                right: 0,
                bottom: 30, // Adjust this value to leave space for the buttons
                child: Material(
              ...
              // Buttons area (edit, delete)
              Positioned(
                bottom: 4,
                right: 4,
                child: IgnorePointer(
                  ignoring: false, // Allow pointer events for the buttons
                  child: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      IconButton(
